...
import { supabase } from '@/lib/supabase'; // تم التغيير للاتصال بـ Supabase الحقيقي
...
export default function ProductsPage() {
  ...
  // جلب المنتجات مباشرة من قاعدة بيانات Supabase الحية
  useEffect(() => {
  ...
  // تصفية وترتيب المنتجات بناءً على البحث والكمية والأسعار
  ...
  // تجميع المنتجات حسب القسم لعرضها بشكل منظم
