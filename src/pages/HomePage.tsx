...
const TESTIMONIALS = [
  ...
  { name: 'عمر خالد', province: 'الإسماعيلية', text: 'اشتريت تليفزيون كبير وقسطته على 24 شهر، الدفعة الشهرية خفيفة جداً عليا.' },
  ...
  { name: 'محمد عبد الرحمن', province: 'الدقهلية', text: 'أفضل تجربة تقسيط جربتها في حياتي. الموافقة سريعة والمشرف محترف.' },
  { name: 'السيدة أمل', province: 'القليوبية', text: 'اشتريت لابتوب لابني الجامعي بقسط مريح. شكراً لباينكس على التسهيلات.' },
  { name: 'طارق محمود', province: 'كفر الشيخ', text: 'التقسيط بدون فوائد حقيقي مش دعاية. جربت بنفسي وشفت الفرق.' },
  { name: 'رانيا فؤاد', province: 'دمياط', text: 'سرعة في الموافقة وجودة في المنتجات. باينكس اسم يثق فيه.' },
  { name: 'خالد عيسى', province: 'بورسعيد', text: 'تعاملت معاهم مرتين وجبت موبايل ولابتوب. كل مرة تجربة أفضل.' },
  { name: 'نورهان سامي', province: 'السويس', text: 'المشرفة كانت جداً محترمة وشرحتلي كل حاجة بالتفصيل. شكراً جزيلاً.' },
  { name: 'ياسر عبد العزيز', province: 'البحيرة', text: 'الموافقة خلال ساعات والمنتج وصلني في نفس الأسبوع. خدمة ممتازة.' },
  { name: 'ميار حسين', province: 'الفيوم', text: 'أخيراً لقيت تقسيط حقيقي بدون فوائد ولا مقدم. باينكس حل الوحيد.' },
  { name: 'عبدالله رمضان', province: 'الغربية', text: 'أنصح كل الناس اللي عايزة تقسط تتعامل مع باينكس. جربت وما ندمتش.' },
  { name: 'هند مصطفى', province: 'المنوفية', text: 'سهولة في التقديم وشفافية في الأسعار. أحسن حاجة إن المشرف بيجيلك البيت.' },
];
